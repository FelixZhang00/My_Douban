package felixzhang.project.my_douban.view;
...
import felixzhang.project.my_douban.view.anim.ResetHeightAnimation;
...
public class ParallaxListView extends ListView {
     ...
     * 刷新 最大高度
     */
    public void invaildMaxHeight() {
        //获得imagview上图片的原始高度，即为imageview的最高度
        this.maxHeight = parallaxImageView.getDrawable().getIntrinsicHeight();
        Logger.i(TAG, "maxHeight change to " + maxHeight);
    }
    ...
    public void setParallaxImageView(ImageView parallaxImageView) {
        ...
        Logger.i(TAG, "First maxHeight = " + maxHeight);
    ...
    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        if (deltaY < 0 && isTouchEvent) {
            ...
            Logger.i(TAG, "newHeight = " + newHeight);
            //达到拖动吃力的效果
            if (newHeight > maxHeight) newHeight = getMaxHeight();
